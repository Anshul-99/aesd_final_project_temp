cmd_arch/arm/boot/dts/omap3-overo-summit.dtb := mkdir -p arch/arm/boot/dts/ ; /home/anshul/aesd/FinalProject_Buildroot_Client/assignment-5-Anshul-99/buildroot/output/host/bin/arm-buildroot-linux-uclibcgnueabihf-gcc -E -Wp,-MD,arch/arm/boot/dts/.omap3-overo-summit.dtb.d.pre.tmp -nostdinc -I./scripts/dtc/include-prefixes -undef -D__DTS__ -x assembler-with-cpp -o arch/arm/boot/dts/.omap3-overo-summit.dtb.dts.tmp arch/arm/boot/dts/omap3-overo-summit.dts ; ./scripts/dtc/dtc -O dtb -o arch/arm/boot/dts/omap3-overo-summit.dtb -b 0 -iarch/arm/boot/dts/ -i./scripts/dtc/include-prefixes -Wno-unit_address_vs_reg -Wno-unit_address_format -Wno-avoid_unnecessary_addr_size -Wno-alias_paths -Wno-graph_child_address -Wno-graph_port -Wno-unique_unit_address -Wno-pci_device_reg  -d arch/arm/boot/dts/.omap3-overo-summit.dtb.d.dtc.tmp arch/arm/boot/dts/.omap3-overo-summit.dtb.dts.tmp ; cat arch/arm/boot/dts/.omap3-overo-summit.dtb.d.pre.tmp arch/arm/boot/dts/.omap3-overo-summit.dtb.d.dtc.tmp > arch/arm/boot/dts/.omap3-overo-summit.dtb.d

source_arch/arm/boot/dts/omap3-overo-summit.dtb := arch/arm/boot/dts/omap3-overo-summit.dts

deps_arch/arm/boot/dts/omap3-overo-summit.dtb := \
...
arch/arm/boot/dts/omap3-overo-summit.dtb: $(deps_arch/arm/boot/dts/omap3-overo-summit.dtb)
