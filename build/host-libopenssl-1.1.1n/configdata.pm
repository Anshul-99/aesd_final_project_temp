...
our %config = (
  ...
  AS => "/usr/bin/as",
  CC => "/usr/bin/gcc",
  CFLAGS => [ "-O2 -I/home/anshul/aesd/FinalProject_Buildroot_Client/assignment-5-Anshul-99/buildroot/output/host/include" ],
  CPP => "/usr/bin/cpp",
  CPPDEFINES => [  ],
  CPPFLAGS => [ "-I/home/anshul/aesd/FinalProject_Buildroot_Client/assignment-5-Anshul-99/buildroot/output/host/include" ],
  CPPINCLUDES => [  ],
  CXX => "/usr/bin/g++",
  CXXFLAGS => [ "-O2 -I/home/anshul/aesd/FinalProject_Buildroot_Client/assignment-5-Anshul-99/buildroot/output/host/include" ],
  HASHBANGPERL => "/usr/bin/perl",
  LD => "/usr/bin/ld",
  LDFLAGS => [ "-L/home/anshul/aesd/FinalProject_Buildroot_Client/assignment-5-Anshul-99/buildroot/output/host/lib -Wl,-rpath,/home/anshul/aesd/FinalProject_Buildroot_Client/assignment-5-Anshul-99/buildroot/output/host/lib" ],
  LDLIBS => [  ],
  PERL => "/usr/bin/perl",
  ...
  libdir => "",
  major => "1",
  makedepprog => "\$(CROSS_COMPILE)/usr/bin/gcc",
  minor => "1.1",
  ...
  openssldir => "/home/anshul/aesd/FinalProject_Buildroot_Client/assignment-5-Anshul-99/buildroot/output/host/etc/ssl",
  options => "--prefix=/home/anshul/aesd/FinalProject_Buildroot_Client/assignment-5-Anshul-99/buildroot/output/host --openssldir=/home/anshul/aesd/FinalProject_Buildroot_Client/assignment-5-Anshul-99/buildroot/output/host/etc/ssl enable-shared enable-zlib-dynamic no-asan no-buildtest-c++ no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fuzz-afl no-fuzz-libfuzzer no-heartbeats no-md2 no-msan no-rc5 no-sctp no-ssl-trace no-ssl3 no-ssl3-method no-tests no-ubsan no-unit-test no-weak-ssl-ciphers",
  perl_archname => "x86_64-linux-gnu-thread-multi",
  perl_cmd => "/usr/bin/perl",
  perl_version => "5.30.0",
  perlargv => [ "linux-x86_64", "--prefix=/home/anshul/aesd/FinalProject_Buildroot_Client/assignment-5-Anshul-99/buildroot/output/host", "--openssldir=/home/anshul/aesd/FinalProject_Buildroot_Client/assignment-5-Anshul-99/buildroot/output/host/etc/ssl", "no-tests", "no-fuzz-libfuzzer", "no-fuzz-afl", "shared", "zlib-dynamic" ],
  perlenv => {
      "AR" => "/usr/bin/ar",
      "ARFLAGS" => undef,
      "AS" => "/usr/bin/as",
  ...
  prefix => "/home/anshul/aesd/FinalProject_Buildroot_Client/assignment-5-Anshul-99/buildroot/output/host",
  processor => "",
