...
{
  return (GET_CODE (op) == CONST_DOUBLE) && ((
#line 238 "../../gcc/config/arm/constraints.md"
...
#line 245 "../../gcc/config/arm/constraints.md"
...
satisfies_constraint_Da (rtx op)
{
  ...
  return 
#line 252 "../../gcc/config/arm/constraints.md"
...
satisfies_constraint_Db (rtx op)
{
  ...
  return 
#line 259 "../../gcc/config/arm/constraints.md"
...
satisfies_constraint_Dc (rtx op)
{
  ...
  return 
#line 267 "../../gcc/config/arm/constraints.md"
...
satisfies_constraint_Dd (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 274 "../../gcc/config/arm/constraints.md"
...
satisfies_constraint_De (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 280 "../../gcc/config/arm/constraints.md"
...
satisfies_constraint_Dg (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 292 "../../gcc/config/arm/constraints.md"
...
satisfies_constraint_Di (rtx op)
{
  ...
  return 
#line 299 "../../gcc/config/arm/constraints.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 314 "../../gcc/config/arm/constraints.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 321 "../../gcc/config/arm/constraints.md"
...
{
  return (GET_CODE (op) == CONST_VECTOR) && (
#line 328 "../../gcc/config/arm/constraints.md"
(TARGET_32BIT
...
{
  return (GET_CODE (op) == CONST_VECTOR) && (
#line 336 "../../gcc/config/arm/constraints.md"
(TARGET_32BIT
...
satisfies_constraint_Do (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 343 "../../gcc/config/arm/constraints.md"
...
{
  return (GET_CODE (op) == CONST_DOUBLE) && (
#line 350 "../../gcc/config/arm/constraints.md"
...
{
  return (GET_CODE (op) == CONST_DOUBLE) && (
#line 357 "../../gcc/config/arm/constraints.md"
...
{
  return (GET_CODE (op) == CONST_DOUBLE) && (
#line 363 "../../gcc/config/arm/constraints.md"
...
{
  return (GET_CODE (op) == CONST_DOUBLE) && (
#line 369 "../../gcc/config/arm/constraints.md"
(TARGET_32BIT
...
{
  return (
#line 375 "../../gcc/config/arm/constraints.md"
(CONSTANT_P (op))) && (
#line 376 "../../gcc/config/arm/constraints.md"
(!arm_disable_literal_pool));
}
static inline bool
...
{
  return (GET_CODE (op) == MEM) && (
#line 390 "../../gcc/config/arm/constraints.md"
...
{
  return (GET_CODE (op) == MEM) && (
#line 397 "../../gcc/config/arm/constraints.md"
...
{
  return (GET_CODE (op) == MEM) && (
#line 403 "../../gcc/config/arm/constraints.md"
...
{
  return (GET_CODE (op) == MEM) && (
#line 409 "../../gcc/config/arm/constraints.md"
...
{
  return (GET_CODE (op) == MEM) && (
#line 416 "../../gcc/config/arm/constraints.md"
...
{
  return (GET_CODE (op) == MEM) && (
#line 423 "../../gcc/config/arm/constraints.md"
...
{
  return (GET_CODE (op) == MEM) && (
#line 430 "../../gcc/config/arm/constraints.md"
...
{
  return (GET_CODE (op) == MEM) && (
#line 445 "../../gcc/config/arm/constraints.md"
(REG_P (XEXP (op, 0))));
}
static inline bool
...
{
  return (GET_CODE (op) == MEM) && (
#line 451 "../../gcc/config/arm/constraints.md"
(TARGET_THUMB
...
{
  return (GET_CODE (op) == MEM) && (
#line 463 "../../gcc/config/arm/constraints.md"
(TARGET_THUMB
		   && thumb1_legitimate_address_p (GET_MODE (op), XEXP (op, 0),
						   0)
		   && GET_CODE (XEXP (op, 0)) != POST_INC));
...
{
  return (GET_CODE (op) == MEM) && (
#line 478 "../../gcc/config/arm/constraints.md"
