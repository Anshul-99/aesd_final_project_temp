...
#line 23 "../../gcc/config/arm/predicates.md"
{
...
{
  return ((
#line 37 "../../gcc/config/arm/predicates.md"
(true)) && (
...
#line 47 "../../gcc/config/arm/predicates.md"
{
...
#line 53 "../../gcc/config/arm/predicates.md"
{
  return (TARGET_NEON
...
#line 64 "../../gcc/config/arm/predicates.md"
{
  return (TARGET_NEON
...
#line 76 "../../gcc/config/arm/predicates.md"
{
...
{
  return ((GET_CODE (op) == REG) && (
#line 83 "../../gcc/config/arm/predicates.md"
...
#line 93 "../../gcc/config/arm/predicates.md"
{
  if (GET_CODE (op) == SUBREG)
    op = SUBREG_REG (op);
...
#line 105 "../../gcc/config/arm/predicates.md"
...
#line 109 "../../gcc/config/arm/predicates.md"
{
  if (GET_CODE (op) == SUBREG)
    op = SUBREG_REG (op);
...
#line 125 "../../gcc/config/arm/predicates.md"
{
...
zero_operand (rtx op, machine_mode mode ATTRIBUTE_UNUSED)
{
  ...
  return (
#line 131 "../../gcc/config/arm/predicates.md"
(op == CONST0_RTX (mode))) && (
(mode == VOIDmode || GET_MODE (op) == mode || GET_MODE (op) == VOIDmode));
}
...
#line 140 "../../gcc/config/arm/predicates.md"
(subreg_lowpart_p (op)));
}
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 149 "../../gcc/config/arm/predicates.md"
...
arm_immediate_di_operand (rtx op, machine_mode mode ATTRIBUTE_UNUSED)
{
  ...
  return (
#line 155 "../../gcc/config/arm/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 159 "../../gcc/config/arm/predicates.md"
(const_ok_for_arm (-INTVAL (op))));
}
...
{
  return (
#line 166 "../../gcc/config/arm/predicates.md"
(op == CONST0_RTX (mode))) && (
(mode == VOIDmode || GET_MODE (op) == mode || GET_MODE (op) == VOIDmode));
}
...
{
  return (const_int_operand (op, mode)) && (
#line 183 "../../gcc/config/arm/predicates.md"
...
{
  return ((
#line 188 "../../gcc/config/arm/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 194 "../../gcc/config/arm/predicates.md"
...
{
  return (const_int_operand (op, mode)) && (
#line 198 "../../gcc/config/arm/predicates.md"
...
#line 207 "../../gcc/config/arm/predicates.md"
...
{
  return (s_register_operand (op, mode)) || ((((GET_CODE (op) == CONST_INT) && (
#line 213 "../../gcc/config/arm/predicates.md"
...
{
  return (s_register_operand (op, mode)) || (((GET_CODE (op) == CONST_INT) && (
#line 224 "../../gcc/config/arm/predicates.md"
(const_ok_for_dimode_op (INTVAL (op), PLUS)))) && (
(mode == VOIDmode || GET_MODE (op) == mode || GET_MODE (op) == VOIDmode)));
}
...
{
  return ((GET_CODE (op) == MEM) && (
#line 243 "../../gcc/config/arm/predicates.md"
...
{
  return (GET_CODE (op) == MEM) && ((
#line 250 "../../gcc/config/arm/predicates.md"
...
arm_reload_memory_operand (rtx op, machine_mode mode ATTRIBUTE_UNUSED)
{
  ...
  return (
#line 256 "../../gcc/config/arm/predicates.md"
((!CONSTANT_P (op)
		     && (true_regnum(op) == -1
			 || (REG_P (op)
			     && REGNO (op) >= FIRST_PSEUDO_REGISTER))))) && (
...
#line 264 "../../gcc/config/arm/predicates.md"
...
shiftable_operator (rtx op, machine_mode mode ATTRIBUTE_UNUSED)
{
  ...
  return 
#line 276 "../../gcc/config/arm/predicates.md"
(mode == GET_MODE (op));
}
...
shiftable_operator_strict_it (rtx op, machine_mode mode ATTRIBUTE_UNUSED)
{
  ...
  return 
#line 280 "../../gcc/config/arm/predicates.md"
(mode == GET_MODE (op));
}
...
logical_binary_operator (rtx op, machine_mode mode ATTRIBUTE_UNUSED)
{
  ...
  return 
#line 285 "../../gcc/config/arm/predicates.md"
(mode == GET_MODE (op));
}
...
#line 300 "../../gcc/config/arm/predicates.md"
(power_of_two_operand (XEXP (op, 1), mode)))) || ((GET_CODE (op) == ROTATE) && (
#line 302 "../../gcc/config/arm/predicates.md"
...
#line 307 "../../gcc/config/arm/predicates.md"
(mode == GET_MODE (op)));
}
...
#line 311 "../../gcc/config/arm/predicates.md"
(CONST_INT_P (XEXP (op, 1))
			      && (UINTVAL (XEXP (op, 1))) < 32))) || ((GET_CODE (op) == ASHIFT || GET_CODE (op) == ASHIFTRT || GET_CODE (op) == LSHIFTRT || GET_CODE (op) == ROTATERT) && (
#line 314 "../../gcc/config/arm/predicates.md"
(!CONST_INT_P (XEXP (op, 1))
			      || (UINTVAL (XEXP (op, 1))) < 32)))) && (
#line 316 "../../gcc/config/arm/predicates.md"
(mode == GET_MODE (op)));
}
...
{
  return (((GET_CODE (op) == MULT) && (
#line 321 "../../gcc/config/arm/predicates.md"
(power_of_two_operand (XEXP (op, 1), mode)))) || ((GET_CODE (op) == ASHIFT || GET_CODE (op) == ASHIFTRT) && (
#line 323 "../../gcc/config/arm/predicates.md"
(CONST_INT_P (XEXP (op, 1))
		              && (UINTVAL (XEXP (op, 1)) < 32))))) && (
#line 325 "../../gcc/config/arm/predicates.md"
(mode == GET_MODE (op)));
}
...
#line 349 "../../gcc/config/arm/predicates.md"
...
{
  return ((expandable_comparison_operator (op, mode)) && (
#line 356 "../../gcc/config/arm/predicates.md"
(maybe_get_arm_condition_code (op) != ARM_NV))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
#line 367 "../../gcc/config/arm/predicates.md"
{
...
{
  return (expandable_comparison_operator (op, mode)) && (
#line 385 "../../gcc/config/arm/predicates.md"
...
{
  return (
#line 395 "../../gcc/config/arm/predicates.md"
(arm_restrict_it)) ? ((
#line 396 "../../gcc/config/arm/predicates.md"
...
minmax_operator (rtx op, machine_mode mode ATTRIBUTE_UNUSED)
{
  ...
  return 
#line 405 "../../gcc/config/arm/predicates.md"
(mode == GET_MODE (op));
}
...
{
  return (GET_CODE (op) == REG) && ((
#line 409 "../../gcc/config/arm/predicates.md"
(REGNO (op) == CC_REGNUM)) && ((
#line 410 "../../gcc/config/arm/predicates.md"
(mode == GET_MODE (op))) || (
#line 411 "../../gcc/config/arm/predicates.md"
...
#line 415 "../../gcc/config/arm/predicates.md"
{
  if (mode == VOIDmode)
    {
      mode = GET_MODE (op);
...
#line 445 "../../gcc/config/arm/predicates.md"
...
#line 465 "../../gcc/config/arm/predicates.md"
{
...
#line 482 "../../gcc/config/arm/predicates.md"
{
  if (s_register_operand (op, mode))
    return true;
...
#line 502 "../../gcc/config/arm/predicates.md"
(arm_disable_literal_pool))) || (
#line 503 "../../gcc/config/arm/predicates.md"
...
#line 511 "../../gcc/config/arm/predicates.md"
(arm_disable_literal_pool))) || ((
#line 512 "../../gcc/config/arm/predicates.md"
(satisfies_constraint_Dy (op))) || (
#line 513 "../../gcc/config/arm/predicates.md"
(satisfies_constraint_G (op))))));
}

static inline int
load_multiple_operation_1 (rtx op ATTRIBUTE_UNUSED, machine_mode mode ATTRIBUTE_UNUSED)
#line 517 "../../gcc/config/arm/predicates.md"
{
...
#line 525 "../../gcc/config/arm/predicates.md"
{
...
#line 533 "../../gcc/config/arm/predicates.md"
{
 return ldm_stm_operation_p (op, /*load=*/true, SImode,
                                 /*consecutive=*/false,
                                 /*return_pc=*/true);
...
#line 541 "../../gcc/config/arm/predicates.md"
{
...
#line 549 "../../gcc/config/arm/predicates.md"
{
...
#line 595 "../../gcc/config/arm/predicates.md"
((UINTVAL (op)) < 256))) && (
(mode == VOIDmode || GET_MODE (op) == mode || GET_MODE (op) == VOIDmode)));
}
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 599 "../../gcc/config/arm/predicates.md"
...
#line 613 "../../gcc/config/arm/predicates.md"
...
#line 629 "../../gcc/config/arm/predicates.md"
{
...
#line 636 "../../gcc/config/arm/predicates.md"
{
...
#line 642 "../../gcc/config/arm/predicates.md"
{
...
#line 648 "../../gcc/config/arm/predicates.md"
{
...
{
  return (
#line 663 "../../gcc/config/arm/predicates.md"
...
#line 674 "../../gcc/config/arm/predicates.md"
{
...
#line 680 "../../gcc/config/arm/predicates.md"
{
...
{
  return ((GET_CODE (op) == CONST_DOUBLE) && (
#line 686 "../../gcc/config/arm/predicates.md"
(TARGET_32BIT
...
{
  return ((GET_CODE (op) == CONST_DOUBLE) && (
#line 691 "../../gcc/config/arm/predicates.md"
(TARGET_32BIT
...
{
  return ((GET_CODE (op) == MEM) && (
#line 696 "../../gcc/config/arm/predicates.md"
...
{
  return ((GET_CODE (op) == MEM) && (
#line 700 "../../gcc/config/arm/predicates.md"
...
#line 715 "../../gcc/config/arm/predicates.md"
...
(((-ival) & 0xfffff000) == 0));
    ...
    case CONSTRAINT_I:
      return 
#line 108 "../../gcc/config/arm/constraints.md"
(TARGET_32BIT ? const_ok_for_arm (ival)
		   : ival >= 0 && ival <= 255);

    case CONSTRAINT_J:
      return 
#line 115 "../../gcc/config/arm/constraints.md"
(TARGET_32BIT ? (ival >= -4095 && ival <= 4095)
		   : (ival >= -255 && ival <= -1));

    case CONSTRAINT_K:
      return 
#line 123 "../../gcc/config/arm/constraints.md"
(TARGET_32BIT ? const_ok_for_arm (~ival)
		   : thumb_shiftable_const (ival));

    case CONSTRAINT_L:
      return 
#line 130 "../../gcc/config/arm/constraints.md"
(TARGET_32BIT ? const_ok_for_arm (-ival)
		   : (ival >= -7 && ival <= 7));

    case CONSTRAINT_M:
      return 
#line 139 "../../gcc/config/arm/constraints.md"
(TARGET_32BIT ? ((ival >= 0 && ival <= 32)
    ...
    case CONSTRAINT_N:
      return 
#line 146 "../../gcc/config/arm/constraints.md"
(!TARGET_32BIT && (ival >= 0 && ival <= 31));

    case CONSTRAINT_O:
      return 
#line 152 "../../gcc/config/arm/constraints.md"
(TARGET_THUMB1 && ival >= -508 && ival <= 508
		   && ((ival & 3) == 0));

    case CONSTRAINT_Pa:
      return 
#line 158 "../../gcc/config/arm/constraints.md"
(TARGET_THUMB1 && ival >= -510 && ival <= 510
		    && (ival > 255 || ival < -255));

    case CONSTRAINT_Pb:
      return 
#line 164 "../../gcc/config/arm/constraints.md"
(TARGET_THUMB1 && ival >= -262 && ival <= 262
		    && (ival > 255 || ival < -255));

    case CONSTRAINT_Pc:
      return 
#line 170 "../../gcc/config/arm/constraints.md"
(TARGET_THUMB1
  		    && ival > 1020 && ival <= 1275);

    case CONSTRAINT_Pd:
      return 
#line 176 "../../gcc/config/arm/constraints.md"
(TARGET_THUMB && ival >= 0 && ival <= 7);

    case CONSTRAINT_Pe:
      return 
#line 181 "../../gcc/config/arm/constraints.md"
...
(TARGET_THUMB2 && ival >= -255 && ival <= 255);
    ...
    case CONSTRAINT_Pt:
      return 
#line 198 "../../gcc/config/arm/constraints.md"
(TARGET_THUMB2 && ival >= -7 && ival <= 7);

    case CONSTRAINT_Pu:
      return 
#line 203 "../../gcc/config/arm/constraints.md"
(TARGET_THUMB2 && ival >= 1 && ival <= 8);

    case CONSTRAINT_Pv:
      return 
#line 208 "../../gcc/config/arm/constraints.md"
(TARGET_THUMB2 && ival >= -255 && ival <= 0);

    case CONSTRAINT_Pw:
      return 
#line 213 "../../gcc/config/arm/constraints.md"
(TARGET_THUMB2 && ival >= -255 && ival <= -1);

    case CONSTRAINT_Px:
      return 
#line 218 "../../gcc/config/arm/constraints.md"
(TARGET_THUMB2 && ival >= -7 && ival <= -1);

    case CONSTRAINT_Py:
      return 
#line 223 "../../gcc/config/arm/constraints.md"
(TARGET_THUMB2 && ival >= 0 && ival <= 255);

    case CONSTRAINT_Pz:
      return 
#line 228 "../../gcc/config/arm/constraints.md"
