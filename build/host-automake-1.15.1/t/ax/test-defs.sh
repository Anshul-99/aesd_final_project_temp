...
am_rel_srcdir='.'
am_top_srcdir='/home/anshul/aesd/FinalProject_Buildroot_Client/assignment-5-Anshul-99/buildroot/output/build/host-automake-1.15.1'
am_top_builddir='/home/anshul/aesd/FinalProject_Buildroot_Client/assignment-5-Anshul-99/buildroot/output/build/host-automake-1.15.1'
...
case ${am_running_installcheck:=no} in
  yes)
    am_amdir='/home/anshul/aesd/FinalProject_Buildroot_Client/assignment-5-Anshul-99/buildroot/output/host/share/automake-1.15/am'
    am_automake_acdir='/home/anshul/aesd/FinalProject_Buildroot_Client/assignment-5-Anshul-99/buildroot/output/host/share/aclocal-1.15'
    am_bindir='/home/anshul/aesd/FinalProject_Buildroot_Client/assignment-5-Anshul-99/buildroot/output/host/bin'
    am_datadir='/home/anshul/aesd/FinalProject_Buildroot_Client/assignment-5-Anshul-99/buildroot/output/host/share'
    am_docdir='/home/anshul/aesd/FinalProject_Buildroot_Client/assignment-5-Anshul-99/buildroot/output/host/share/doc/automake'
    am_pkgvdatadir='/home/anshul/aesd/FinalProject_Buildroot_Client/assignment-5-Anshul-99/buildroot/output/host/share/automake-1.15'
    am_scriptdir='/home/anshul/aesd/FinalProject_Buildroot_Client/assignment-5-Anshul-99/buildroot/output/host/share/automake-1.15'
    am_system_acdir='/home/anshul/aesd/FinalProject_Buildroot_Client/assignment-5-Anshul-99/buildroot/output/host/share/aclocal'
    ;;
  no)
...
FC=${AM_TESTSUITE_FC-${FC-'f95'}}
CFLAGS=${AM_TESTSUITE_CFLAGS-${CFLAGS-'-O2 -I/home/anshul/aesd/FinalProject_Buildroot_Client/assignment-5-Anshul-99/buildroot/output/host/include'}}
CXXFLAGS=${AM_TESTSUITE_CXXFLAGS-${CXXFLAGS-'-O2 -I/home/anshul/aesd/FinalProject_Buildroot_Client/assignment-5-Anshul-99/buildroot/output/host/include'}}
FCFLAGS=${AM_TESTSUITE_FCFLAGS-${FCFLAGS-'-g -O2'}}
FFLAGS=${AM_TESTSUITE_FFLAGS-${FFLAGS-'-g -O2'}}
CPPFLAGS=${AM_TESTSUITE_CPPFLAGS-${CPPFLAGS-'-I/home/anshul/aesd/FinalProject_Buildroot_Client/assignment-5-Anshul-99/buildroot/output/host/include'}}
...
GNU_F77=${AM_TESTSUITE_GNU_F77-${GNU_F77-'f77'}}
GNU_FC=${AM_TESTSUITE_GNU_FC-${GNU_FC-'f95'}}
GNU_FFLAGS=${AM_TESTSUITE_GNU_FFLAGS-${GNU_FFLAGS-'-g -O2'}}
GNU_FCFLAGS=${AM_TESTSUITE_GNU_FCFLAGS-${GNU_FCFLAGS-'-g -O2'}}
GNU_CXXFLAGS=${AM_TESTSUITE_GNU_CXXFLAGS-${GNU_CXXFLAGS-'-O2 -I/home/anshul/aesd/FinalProject_Buildroot_Client/assignment-5-Anshul-99/buildroot/output/host/include'}}
GNU_CFLAGS=${AM_TESTSUITE_GNU_CFLAGS-${GNU_CFLAGS-'-O2 -I/home/anshul/aesd/FinalProject_Buildroot_Client/assignment-5-Anshul-99/buildroot/output/host/include'}}
